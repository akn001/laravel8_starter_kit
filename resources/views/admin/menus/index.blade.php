...
<div class="layout-px-spacing">
    ...
    ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form class="form-horizontal validate_form" id="update_menu{{$row->main_id}}" method="POST" action="{{route('admin.menus.update',$row->main_id)}}">
                  @csrf
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control required" id="Title" name="Title" value="{{$row->name}}">	
                      </div>
                    </div>
        ...
        <!-- /.modal -->
      <script>
        $('#update_menu{{$row->main_id}}').validate({
            submitHandler(form){
              form.submit();
              return false;
            }
    ...
    <div class="modal fade" id="addMenu">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal validate_form" id="add_menu" method="post" action="{{route('admin.menus.store')}}">
              @csrf
              <div class="box-body">
                <div class="form-group">
                  <label for="Title" class="col-sm-4 control-label">{{trans('label.Menu')}} {{trans('label.Name')}}: <?=$required_span; ?></label>
