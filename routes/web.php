...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    //saloon owners
    Route::get('/saloonOwners', 'Admin\UsersController@saloonOwners')->name('saloonOwners');
    Route::get('/ownersList', 'Admin\UsersController@ownersList')->name('ownersList');
    Route::get('/addOwner', 'Admin\UsersController@addOwner')->name('addOwner');
    Route::post('/DoAddOwner', 'Admin\UsersController@DoAddOwner')->name('DoAddOwner');
    Route::get('change-status/{id}', 'Admin\UsersController@change_status')->name('owners.change_status');
    Route::get('/editOwner/{id}/{tab?}', 'Admin\UsersController@editOwner')->name('editOwner');
    Route::post('/DoEditOwner/{id}', 'Admin\UsersController@DoEditOwner')->name('DoEditOwner');
    Route::POST('/DeleteOwner', 'Admin\UsersController@deleteOwner')->name('deleteOwner');
